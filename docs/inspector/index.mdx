...
<Frame caption="Tools list showing 23 available Linear tools">
  <img
    src="/images/inspector/tools-list.png"
    alt="Tools tab interface showing list of available tools"
  />
</Frame>
...
<Frame caption="Resources tab showing no resources available">
  <img
    src="/images/inspector/resources-empty.png"
    alt="Resources tab interface showing empty state"
  />
</Frame>
...
<Frame caption="Prompts tab showing no prompts available">
  <img
    src="/images/inspector/prompts-empty.png"
    alt="Prompts tab interface showing empty state"
  />
</Frame>
...
<Frame caption="Prompts dropdown showing available prompts">
  <img
    src="/images/inspector/prompts-selection.png"
    alt="Chat input with prompts dropdown showing available prompts after typing /"
  />
</Frame>
...
<Frame caption="Selected prompt with results displayed in chat">
  <img
    src="/images/inspector/prompts-selected.png"
    alt="Chat showing executed prompt result included in the message"
  />
</Frame>
